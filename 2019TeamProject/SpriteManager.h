...
public:
	...
	int LoadProjectileSprite(const std::string& filePath, SDL_Renderer* renderer,
		int renderXPos = 0, int renderYPos = 0);
	...
	void RenderProjectileSprite(SDL_Renderer* renderer, size_t index, const RenderConfig& renderConfig);
};
